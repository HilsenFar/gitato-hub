...
// anything. The WebP covers the page actually shows are cached as they load,
...
self.addEventListener('fetch', (e) => {
  ...
  // Same origin only. The release board reads api.github.com; those answers
  // have their own hour-long cache in the page and must not be frozen here.
